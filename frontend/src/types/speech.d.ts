 ...
 * Provides type definitions for SpeechRecognition and SpeechSynthesis
 */
...
// Speech Synthesis API (already mostly defined in lib.dom.d.ts, but adding missing parts)
